...
class SignUpFragment : Fragment(R.layout.fragment_auth_signup) {
    ...
    private fun setupListeners() {
        ...
        binding.btnSignUpAction.setOnClickListener {
            ...
            // Basic Validation
            if (tenantName.isEmpty() || companyName.isEmpty() || adminName.isEmpty() || emailId.isEmpty() || phone.isEmpty() || password.isEmpty()) {
            ...
            viewModel.signUp(tenantName, companyName, adminName, fullEmail, phone, password)
        }
